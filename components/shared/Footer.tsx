        ...
        <div className="max-w-[1688px] mx-auto bg-[#242728] py-[60px] px-[79px] flex flex-col items-center gap-[60px] rounded-t-[40px] rounded-b-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-white/20 w-full items-start">
            {isLoading
              ? [0, 1, 2, 3].map((i) => {
                const paddingClass =
                  i === 0 ? "md:pr-[15px]" : i === 3 ? "md:pl-[15px]" : "md:px-[15px]";
                return (
                ...
                .map((office: any, index: any, arr: any) => {
                  ...
                  const paddingClass = isFirst
                    ...
                    : isLast
                      ...
                      : "md:px-[15px]";
                  return (
                    <div key={office.id} className={`${paddingClass} pt-4 md:pt-0 self-start`}>
        ...
        <div className="relative w-full max-w-[1880px] mx-auto overflow-hidden rounded-[40px]">
          ...
          <div className="relative z-10 flex flex-col items-start gap-[40px] self-stretch px-[60px] pt-[60px] pb-[40px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1.8fr_0.85fr_0.85fr_1fr_1.2fr] gap-x-[40px] gap-y-10 w-full">
              ...
              <div>
                <h4 className="font-semibold text-white mb-5 text-[24px] leading-[150%] font-[Quicksand]">Others</h4>
                <ul className="space-y-[10px] text-[20px] text-white font-normal font-[Quicksand] leading-[150%]">
                  <li>
                    <Link href="/medical-team" className="hover:text-white transition-colors">
                      Medical Team
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-[10px] text-[20px] text-white font-normal font-[Quicksand] leading-[150%]">
                  ...
                  <li>
                    <Link href="/report-side-effect" className="hover:text-white transition-colors">
                      Report Side Effect
                    </Link>
                  </li>
                  <li>
                    <Link href="/request-your-records" className="hover:text-white transition-colors">
                      Request Records
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                <h4 className="font-semibold text-white mb-5 text-[24px] leading-[150%] font-[Quicksand]">Legal Disclaimer</h4>
                <ul className="space-y-[10px] text-[20px] text-white font-normal font-[Quicksand] leading-[150%]">
                  <li>
                  ...
                  <li>
                    <Link href="/billing-and-cancellation" className="hover:text-white transition-colors">
              ...
              {/* Col 5: Contact Us */}
              <div>
                <h4 className="font-semibold text-white mb-5 text-[24px] leading-[150%] font-[Quicksand]">Contact Us</h4>
                <ul className="space-y-[10px] text-[20px] text-white font-normal font-[Quicksand] leading-[150%]">
                  {isLoading ? (
                    <>
                      {[0, 1, 2, 3].map((i) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1.8fr_0.85fr_0.85fr_1fr_1.2fr] gap-x-[40px] w-full">
              ...
              <div className="flex items-center gap-4 justify-end">
                ...
                {/* Visa SVG — 68×22px */}
                <svg xmlns="http://www.w3.org/2000/svg" width="69" height="23" viewBox="0 0 69 23" fill="none" style={{ width: '68.018px', height: '22.346px' }}>
                  <path fillRule="evenodd" clipRule="evenodd" d="M17.0053 22.1724H11.1187L6.70452 4.83668C6.49501 4.03924 6.05015 3.33425 5.39577 3.00198C3.76269 2.16698 1.96314 1.50244 0 1.16729V0.499862H9.48277C10.7915 0.499862 11.7731 1.50244 11.9367 2.66683L14.227 15.1716L20.1107 0.499862H25.8337L17.0053 22.1724ZM29.1055 22.1724H23.5461L28.1239 0.499862H33.6833L29.1055 22.1724ZM40.8758 6.50378C41.0394 5.33651 42.0209 4.66908 43.1661 4.66908C44.9657 4.50151 46.9259 4.83666 48.5619 5.66878L49.5434 1.00258C47.9075 0.335157 46.1079 0 44.4749 0C39.0791 0 35.1528 3.00197 35.1528 7.16832C35.1528 10.3379 37.9339 12.0021 39.8971 13.0047C42.0209 14.0044 42.8389 14.6718 42.6753 15.6715C42.6753 17.171 41.0394 17.8384 39.4063 17.8384C37.4431 17.8384 35.48 17.3386 33.6833 16.5036L32.7018 21.1727C34.6649 22.0048 36.7888 22.34 38.7519 22.34C44.8021 22.5046 48.5619 19.5056 48.5619 15.0041C48.5619 9.33528 40.8758 9.00301 40.8758 6.50378ZM68.0182 22.1724L63.604 0.499862H58.8626C57.881 0.499862 56.8994 1.16729 56.5722 2.16698L48.3982 22.1724H54.1212L55.2635 19.0057H62.2952L62.9496 22.1724H68.0182ZM59.6806 6.3363L61.3136 14.5043H56.7358L59.6806 6.3363Z" fill="white" />
                </svg>
              </div>
            </div>
                  ...
                  <div className="flex gap-3 text-white items-center">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path fillRule="evenodd" clipRule="evenodd" d="M5.27938 3H18.7194C19.7798 3 20.6394 3.89543 20.6394 5V19C20.6394 20.1046 19.7798 21 18.7194 21H5.27938C4.21899 21 3.35938 20.1046 3.35938 19V5C3.35938 3.89543 4.21899 3 5.27938 3ZM8.15938 18C8.42447 18 8.63938 17.7761 8.63938 17.5V10.5C8.63938 10.2239 8.42447 10 8.15938 10H6.71938C6.45428 10 6.23938 10.2239 6.23938 10.5V17.5C6.23938 17.7761 6.45428 18 6.71938 18H8.15938ZM7.43937 9C6.64408 9 5.99938 8.32843 5.99938 7.5C5.99938 6.67157 6.44408 6 7.43937 6C8.23467 6 8.87938 6.67157 8.87938 7.5C8.87938 8.32843 8.23467 9 7.43937 9ZM17.2794 18C17.5444 18 17.7594 17.7761 17.7594 17.5V12.9C17.7906 11.3108 16.6627 9.95452 15.1482 9.76C14.0893 9.65925 13.0633 10.1744 12.4794 11.1V10.5C12.4794 10.2239 12.2644 10 11.9994 10H10.5594C10.2943 10 10.0794 10.2239 10.0794 10.5V17.5C10.0794 17.7761 10.2943 18 10.5594 18H11.9994C12.2644 18 12.4794 17.7761 12.4794 17.5V13.75C12.4794 12.9216 13.1241 12.25 13.9194 12.25C14.7146 12.25 15.3594 12.9216 15.3594 13.75V17.5C15.3594 17.7761 15.5743 18 15.8394 18H17.2794Z" fill="white" />
                      </svg>
                    </Link>
                  </div>
                </div>
              </div>
            </div>{/* ── end Row 3 wrapper ── */}
          </div>
        </div>
      </div>
    </footer>
