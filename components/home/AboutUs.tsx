...
const AboutUs = () => {
  // Mock data for the service cards to keep the JSX clean and dry
  const services = [
    {
      id: "hormone",
    ...
    <section className="w-full max-w-6xl mx-auto px-4 py-16 flex flex-col items-center font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full mb-16">
        ...
        <div className="bg-blue-50/50 rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-4 border border-blue-50/20 min-h-[140px]">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm px-6 py-2.5 rounded-full transition-colors duration-200 shadow-md shadow-blue-600/10 active:scale-98">
            Learn More
          </button>
        </div>
      </div>

      {/* Custom Shaped Hero Video Banner */}
      <div className="w-full relative group overflow-hidden rounded-2xl">
        <video
          ...
          style={{
            // Exact same clip-path vector mask applied to the moving video
            clipPath:
          ...
          playsInline
        >
          {/* Replace with your local public folder video asset or remote URL */}
          <source src="/aboutUs.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>

        {/* Subtle overlay matching Figma's cinematic depth */}
        <div
