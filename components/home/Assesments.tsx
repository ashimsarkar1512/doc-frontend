    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-5xl font-bold leading-[1.3] mb-4 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">
            {content?.assessmentTitle || "Start from a tailored assessment"}
          </h2>
          <p className="text-gray-500 text-sm md:text-2xl lg:text-3xl max-w-2xl mx-auto leading-relaxed">
