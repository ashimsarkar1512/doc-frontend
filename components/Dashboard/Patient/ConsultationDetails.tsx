...
export default function ConsultationDetails({ consultation, onBack }: ConsultationDetailsProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-in fade-in duration-200">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h4 className="text-base font-bold text-gray-900 leading-tight">Patient: Alan Cattoch</h4>
              <p className="text-xs text-gray-400 font-light mt-0.5">
                Consultation id: {consultation.id} &nbsp;&bull;&nbsp; Submitted: 18 May, 2026
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className={`text-[11px] font-bold text-white px-3 py-1 rounded-full uppercase tracking-wide ${
              consultation.status === 'Approved' ? 'bg-[#10b981]' :
              consultation.status === 'Pending' ? 'bg-[#f59e0b]' : 'bg-[#ef4444]'
            }`}>
              {consultation.status}
            </span>
          </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-white rounded-[20px] border border-gray-150 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col gap-5">
          ...
          <div className="bg-[#fdf2f2] border border-[#fde2e2] rounded-[14px] p-4 flex flex-col gap-1">
            <span className="text-[13px] font-semibold text-gray-800">Health Snapshot:</span>
        ...
        <div className="bg-white rounded-[20px] border border-gray-150 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 pl-1">
            ...
            {renderCheckedItem('Heart disease, stroke, or peripheral vascular disease')}
        ...
        <div className="bg-white rounded-[20px] border border-gray-150 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 pl-1">
            {renderCheckedItem('Multiple Endocrine Neoplasia syndrome type 2 (MEN2)')}
        ...
        <div className="bg-white rounded-[20px] border border-gray-150 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col gap-4">
          ...
          {renderRadioItem('No, I am not currently taking a GLP-1 medication in the past 30 days')}
        </div>
        ...
        <div className="bg-white rounded-[20px] border border-gray-150 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 pl-1">
            ...
            {renderCheckedItem('Diuretics such as (but not limited to) furosemide (Lasix), bumetanide (Bumex), Hydrochlorothiazide/HCTZ')}
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-150 p-6 shadow-[0_2px_8px_rgba(0,0,0,0.01)] flex flex-col gap-6 mb-12">
        <div>
          <h4 className="text-lg font-bold text-gray-900 leading-tight">Product & Payment Summary</h4>
          <p className="text-xs text-gray-400 font-light mt-1">Patient selected two products:</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 p-3 bg-gray-50/50 rounded-2xl border border-gray-100">
              ...
              <div className="flex-1 min-w-0">
                <h5 className="text-[15px] font-bold text-gray-900 truncate">Phentermine</h5>
                <p className="text-xs text-gray-400 truncate mt-0.5">Medium Rare, Bone Marrow Butter</p>
              </div>
              <span className="text-[15px] font-bold text-blue-600 pr-2">$48</span>
            </div>
            ...
            <div className="flex items-center gap-4 p-3 bg-gray-50/50 rounded-2xl border border-gray-100">
              ...
              <div className="flex-1 min-w-0">
                <h5 className="text-[15px] font-bold text-gray-900 truncate">Vitamin C Ascorbic Acid</h5>
                <p className="text-xs text-gray-400 truncate mt-0.5">Medium Rare, Bone Marrow Butter</p>
              </div>
              <span className="text-[15px] font-bold text-blue-600 pr-2">$48</span>
            </div>
          ...
          <div className="lg:col-span-5 bg-gray-50/50 border border-gray-100 rounded-2xl p-5 flex flex-col gap-4 text-sm">
            ...
            <div className="flex justify-between items-center text-gray-500 font-light pb-3 border-b border-gray-200/60">
              ...
              <span className="font-semibold text-emerald-600 font-medium">+ $50.00</span>
            </div>

            <div className="flex justify-between items-center">
              <div className="flex flex-col">
                <span className="text-base font-bold text-gray-950">Total payable</span>
