      ...
      <section className="max-w-[1300px] mx-auto px-4 sm:px-6 mt-16 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            {/* Full Name */}
            <div>
              <label htmlFor="fullName" className="block text-[15px] font-bold text-gray-900 mb-2.5">
              ...
              />
              {errors.fullName && (
                <p className="mt-1.5 text-[13px] text-red-500">{errors.fullName}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="email" className="block text-[15px] font-bold text-gray-900 mb-2.5">
              ...
              <div>
                <label htmlFor="phone" className="block text-[15px] font-bold text-gray-900 mb-2.5">
                  Contact Number
                </label>
                <input
                  id="phone"
            ...
            {/* Service */}
            <div>
              <label htmlFor="service" className="block text-[15px] font-bold text-gray-900 mb-2.5">
                What service are you interested in? (optional)
              </label>
            ...
            {/* Message */}
            <div>
              <label htmlFor="message" className="block text-[15px] font-bold text-gray-900 mb-2.5">
                Message / Questions:
              </label>
              <textarea
                id="message"
