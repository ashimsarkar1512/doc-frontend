...
export default function MedicalTeamPage() {
  const providerNetwork = [
    { name: "Jeffrey Richker MD", role: "Licensed Colorado Physician", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "18 Years Clinical Practice", specialties: ["Obesity Medicine", "Endocrinology", "Internal Medicine", "Metabolic Disorders"], image: "/expartProviders/expart1.png" },
    { name: "Jeffrey Richker MD", role: "Licensed Colorado Physician", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "18 Years Clinical Practice", specialties: ["Obesity Medicine", "Endocrinology", "Internal Medicine", "Metabolic Disorders"], image: "/expartProviders/expart1.png" },
    { name: "Natalie Nicholas NP", role: "Licensed Colorado Nurse Practitioner", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "8 Years Experience", specialties: ["Family Medicine", "Women's Health", "Preventive Care"], image: "/expartProviders/expart2.png" },
    { name: "David Kim, NP-C", role: "Licensed Colorado Nurse Practitioner", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "9 Years Experience", specialties: ["Family Medicine", "Chronic Disease Management", "Primary Care"], image: "/expartProviders/expart3.png" },
    { name: "Brooklynn Simmons", role: "Licensed Colorado Physician", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "10 Years Experience", specialties: ["Obesity Medicine", "Preventive Medicine"], image: "/expartProviders/expart1.png" },
    { name: "Kristin Watson", role: "Licensed Colorado Physician", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "8 Years Experience", specialties: ["Internal Medicine", "Metabolic Health"], image: "/expartProviders/expart2.png" },
    { name: "Devon Lane", role: "Licensed Colorado Nurse Practitioner", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "11 Years Experience", specialties: ["Family Nurse Practitioner", "Weight Management"], image: "/expartProviders/expart3.png" },
    { name: "Arlene McCoy", role: "Licensed Colorado Physician", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "15 Years Experience", specialties: ["Internal Medicine", "Obesity Medicine"], image: "/expartProviders/expart1.png" },
    { name: "Albert Flores", role: "Licensed Colorado Physician", licenses: "TX #G12345 | CA #G67890 | NY #G11223", experience: "12 Years Experience", specialties: ["Endocrinology", "Metabolic Disorders"], image: "/expartProviders/expart2.png" },
  ];
  ...
  return (
   ...
   <section className="pt-24 md:pt-28 px-4 sm:px-6 max-w-[1200px] mx-auto w-full">
      <div 
        ...
        style={{
          borderRadius: '40px',
          background: 'linear-gradient(0deg, #EBEEF2 0%, #EBEEF2 100%), linear-gradient(180deg, rgba(0, 0, 0, 0.00) 0%, rgba(0, 0, 0, 0.70) 100%)',
        ...
        <div className="flex flex-col gap-3.5 lg:col-span-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 mt-1.5">
            <div className="bg-[#edf2f7] rounded-[14px] p-3.5 sm:col-span-7">
              <p className="text-[#3b7ddd] text-[13px] font-semibold mb-0.5">State Licenses</p>
              <p className="text-[#4a5463] text-[13px] font-medium">TX #G12345 | CA #G67890 | NY #G11223</p>
            </div>
            <div className="bg-[#edf2f7] rounded-[14px] p-3.5 sm:col-span-5">
              <p className="text-[#3b7ddd] text-[13px] font-semibold mb-0.5">Experience</p>
              <p className="text-[#4a5463] text-[13px] font-medium">18 Years Clinical Practice</p>
            </div>
          </div>
            ...
            <div key={index} className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <svg className="w-3 h-3 text-[#2563eb]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-xs text-gray-500">{provider.licenses}</span>
                </div>
