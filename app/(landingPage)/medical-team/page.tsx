...
export default function MedicalTeamPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* ── PROVIDER NETWORK ── */}
    <section className="max-w-[1520px] mx-auto px-4 sm:px-6 mt-16 mb-24 w-full">
      <FadeIn className="text-center mb-[80px]">
        {isTeamSectionLoading ? (
          ...
          <>
            <h2
              className="text-2xl md:text-[54px] font-semibold tracking-tight mx-auto"
              style={{
      ...
      <ContactCTA pageType="MedicalTeam" />
